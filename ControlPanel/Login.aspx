...
<body>
    <form id="form1" runat="server">
                                               ...
                                               <table class="table table-bordered table-responsive">
                                                    ...
                                                    <tbody>
                                                         <tr>
                                                            ...
                                                            <td>master123</td>
                                                            <td>
                                                                <i data-original-title="copy" title="" data-placement="top" data-toggle="tooltip" onclick="copy('sufia' , 'master123','master')" class="fa fa-copy icon-hover tooltip-default"></i>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Admin</td>
                                                            ...
                                                            <td>admin123</td>
                                                            <td>
                                                                <i data-original-title="copy" title="" data-placement="top" data-toggle="tooltip" onclick="copy('binoy' , 'admin123','admin')" class="fa fa-copy icon-hover tooltip-default"></i>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>User</td>
                                                            ...
                                                            <td>user123</td>
                                                            <td>
                                                                <i data-original-title="copy" title="" data-placement="top" data-toggle="tooltip" onclick="copy('arifur' , 'user123','user')" class="fa fa-copy icon-hover tooltip-default"></i>
                                                            </td>
                                                        </tr>                         
                                                    </tbody>
                                                </table>
        ...
        <%-----------------------------------------------------%>
        <div id="footer" class="hidden-xs hidden-xs">
            <div class="fleft"></div>
            <div class="fright">
    ...
    <script type="text/javascript">
        ...
        function validateLogIn() {
            ...
            if (validateText('txtPassword', 3, 100, 'Password must be 3-100 characters long') == false) return false;
            return true;
        }
    </script>
    <script type="text/javascript">
