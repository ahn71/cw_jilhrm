        ...
        <div class="col-md-12">
            <div class="ds_nagevation_bar">
                <ul>
                    ...
                    <li><a class="seperator" href="#">/</a></li>
                    <li><a href="#" class="ds_negevation_inactive Pactive">Pay Slip</a></li>
                </ul>
            </div>
        </div>
    </div>
                  ...
                  <div class="bonus_generation" style="width: 61%; margin: 0px auto;">           
                    <h1  runat="server" visible="false" id="WarningMessage"  style="color:red; text-align:center"></h1>
                     <table runat="server" visible="true" id="tblGenerateType" class="bonus_generation_table super_admin_option">                 
                                <tr>                                    
                                    <td>
                                        <asp:CheckBox ID="chkForAllCompany" runat="server" Text="For All Companies" AutoPostBack="True" Visible="False" />                                    </td>                         
                                   <td>
                                      <%-- <asp:CheckBox ID="ckbBankForwardingReport" Visible="false" runat="server" Text="Bank Forwarding Letter" />--%>
                                   </td>
                                    <td></td>
                                    <td>
