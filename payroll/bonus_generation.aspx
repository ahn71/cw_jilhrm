                 ...
                 <div class="input_division_info">
                    <table class="division_table">
                        ...
                        <tr>
                                        ...
                                        <td>
                                           <asp:TextBox runat="server" ID="txtCardNo" placeholder="0000,0001,......,nnnn" CssClass="form-control text_box_width"></asp:TextBox>
                                        </td>
                                    </tr>
                        <tr>
                                        <td>
                                        ...
                                        <td>
                                           <asp:TextBox runat="server" ID="txtBonusHoldCardNo" placeholder="0000,0001,......,nnnn" CssClass="form-control text_box_width"></asp:TextBox>
                                        </td>
                                    </tr>
                        <tr>
                                <td>
                                ...
                                <td>
                                    <asp:CheckBox runat="server" ClientIDMode="Static" ID="ckbIsProRataBasis" Text="Pro-rata Basis" />                                  
                         ...
                         <tr>
                              ...
                              <td>
                                           <asp:Label runat="server" Visible="false" ID="lblGenerationStatus">Generating..</asp:Label>
                                        </td>
                                    </tr>
                     </table>
                </div>            
