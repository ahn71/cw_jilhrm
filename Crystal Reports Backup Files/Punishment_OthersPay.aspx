<%@ Page Title="Deductions" Language="C#" MasterPageFile="~/payroll_nested.master" AutoEventWireup="true" CodeBehind="Punishment_OthersPay.aspx.cs" Inherits="SigmaERP.payroll.Punishment_OthersPay" %>
        ...
        <div class="col-md-12">
            <div class="ds_nagevation_bar">
                <ul>
                    ...
                    <li><a class="seperator" href="#">/</a></li>
                     <li> <a href="#" class="ds_negevation_inactive Pactive">Deductions</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                        ...
                        <ContentTemplate>
                            ...
                            <asp:TabContainer ID="tc1" runat="server" CssClass="fancy fancy-green" AutoPostBack="true" OnActiveTabChanged="tc1_ActiveTabChanged" ActiveTabIndex="0">
                                        ...
                                        <table class="em_button_table">
                                            <tr>
                                              ...
                                              <%--  <th>
                                                ...
                                                <th>
                                                    <asp:Button ID="btnClose3" Class="Pbutton" runat="server" Text="Close" PostBackUrl="/payroll/salary_index.aspx" /></th>
                                ...
                                <asp:TabPanel runat="server"  TabIndex="1" ID="tab1" HeaderText="Adjustment">
                                    <ContentTemplate>
                                ...
                                <asp:TabPanel runat="server" ID="tab2" TabIndex="2" HeaderText="Other's Pay" Visible="false">
                                    <ContentTemplate>
