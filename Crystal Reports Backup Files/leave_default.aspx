               ...
               <div class="row">
                 <div class=" col-md-2"></div>
                  ...
                  <div class=" col-md-2 " title="Yearly Purpose Report" runat="server" id="pLeaveYearlyReport">
                      <a class="ds_leave_Basic_Text" href="/leave/yearly_leaveStatus_report.aspx"><img class="image_width_for_module" src="images/common/businesstype.ico" /><br />Leave Report</a> 
                 </div>
