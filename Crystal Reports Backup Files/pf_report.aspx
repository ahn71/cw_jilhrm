<%@ Page Title="" Language="C#" MasterPageFile="~/payroll_nested.master" AutoEventWireup="true" CodeBehind="pf_report.aspx.cs" Inherits="SigmaERP.pf.pf_report" %>
                          ...
                          <td>Report &nbsp;</td>                      
                           <td colspan="3">
                                 <asp:RadioButtonList ID="rblReportType" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
				                    <asp:ListItem  Value="0" Text="Monthly PF Sheet" Selected="True"></asp:ListItem>                                   
