...
<h1  runat="server" visible="false" id="WarningMessage"  style="color:red; text-align:center"></h1>
                    ...
                    <table runat="server" visible="true" id="tblGenerateType" class="division_table_leave1 " >
                        ...
                        <tr id="trCompanyName" runat="server" visible="true" class="hidden-xs hidden-sm">
                            <td>Company
                            </td>
                            <td>:</td>
                            <td>
                        ...
                        <tr >
                            <td class="hidden-xs hidden-sm">Employee Type
                            </td>
                            ...
                            <td>:</td>
                            <td>
                                <asp:TextBox ID="txtDate" ClientIDMode="Static" runat="server" CssClass="form-control text_box_width key-off"></asp:TextBox>
                        ...
                        <div class="job_card_button_area">
                            <div>
                              ...
                              <asp:RadioButtonList class="rb" ID="rblPrintType" runat="server"  RepeatDirection="Horizontal" >
                                    ...
                                    <asp:RadioButtonList class="rb" ID="rblLanguage" runat="server"   visible="false" RepeatDirection="Horizontal" >
