...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="max-width:800px; margin:0px auto">
        ...
        <div style="width: 100%; margin:0px auto">
                       <asp:GridView HeaderStyle-BackColor="#5EC1FF" ID="gvLateNotification" HeaderStyle-Height="28px" runat="server" AutoGenerateColumns="false" BackColor="White" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="14px"  Width="100%">
            ...
            <div style="width: 100%; margin:0px auto">
                       <asp:GridView HeaderStyle-BackColor="#5EC1FF" ID="gvPermanentNotification" HeaderStyle-Height="28px" runat="server" AutoGenerateColumns="false" BackColor="White" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="14px"  Width="100%" >
                          <PagerStyle CssClass="gridview" />
                          <Columns>
        ...
        <div style="width: 100%; margin:0px auto">
                       <asp:GridView HeaderStyle-BackColor="#5EC1FF" ID="gvBirthDayNotification" HeaderStyle-Height="28px" runat="server" AutoGenerateColumns="false" BackColor="White" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="14px"  Width="100%" >                          
                          <Columns>
                              
                              <asp:BoundField DataField="EmpCardNo" HeaderText="Card No"  ItemStyle-HorizontalAlign="Center" />
                               <asp:BoundField DataField="EmpName" HeaderText="Name"  ItemStyle-HorizontalAlign="left" />
                               <asp:BoundField DataField="DsgName" HeaderText="Designation"  ItemStyle-HorizontalAlign="Left" />
                              <asp:BoundField DataField="Birthday" HeaderText="Birthday"   ItemStyle-HorizontalAlign="Center" />                             
