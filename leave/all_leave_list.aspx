...
<div style="padding:0;margin-top:25px;max-width:100%;">
    <div class="row Rrow">
               ...
               <div style="width:100%;">
                  ...
                  <table width="99%" style="margin:0 0 5px 6px; border-collapse: collapse;"  class="hidden-xs">
                       <tr>
                            <td>Company</td>
                           <td>Depertment</td>
                           <%-- <td>Shift</td>--%>
                  ...
                  <div style="width: 100%; margin:0px auto ">
                       <asp:GridView HeaderStyle-BackColor="#5EC1FF" ID="gvLeaveList" HeaderStyle-Height="28px" runat="server" AutoGenerateColumns="false" BackColor="White" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="14px" AllowPaging="true" PageSize="40" Width="100%" DataKeyNames="LACode" OnRowCommand="gvLeaveList_RowCommand" OnRowDataBound="gvLeaveList_RowDataBound" OnPageIndexChanging="gvLeaveList_PageIndexChanging" OnRowDeleting="gvLeaveList_RowDeleting">
                          ...
                          <Columns>
                              ...
                              <asp:BoundField DataField="CurrentProcessStatus" HeaderText="Processed" Visible="false" ItemStyle-Font-Bold="true" ItemStyle-HorizontalAlign="Center"  />
                              ...
                              <%--  <asp:ButtonField ButtonType="Button" HeaderText="Alter" Text="Alter" CommandName="Alter" />--%>
                                 <asp:TemplateField>
                                  ...
                                  <ItemTemplate>
                                      <asp:Button runat="server" ID="btnReport" cssClass="btn-xs btn-primary" Text="View" Font-Bold="true" CommandName="View" ForeColor="White" CommandArgument='<%# Eval("LACode") %>' />
                                  </ItemTemplate>
                                   <ItemStyle HorizontalAlign="Center" />
                              </asp:TemplateField>
                              <asp:TemplateField>
                                  ...
                                  <ItemTemplate>
                                      <asp:Button runat="server" ID="btnEdit" cssClass="btn-xs btn-info" Text="Edit" Font-Bold="true" CommandName="Alter" ForeColor="White" CommandArgument='<%#((GridViewRow)Container).RowIndex%>' />
                                  </ItemTemplate>
                                   <ItemStyle HorizontalAlign="Center" />
                              </asp:TemplateField>
                              <asp:TemplateField>
                                  ...
                                  <ItemTemplate>
                                      <asp:Button ID="btnView" runat="server" cssClass="btn-xs btn-danger" Text="Delete" Font-Bold="true" CommandName="Delete" ForeColor="White"
