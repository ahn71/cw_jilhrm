<%@ Page Title="Leave Status Reports" Language="C#" MasterPageFile="~/leave_nested.master" AutoEventWireup="true" CodeBehind="yearly_leaveStatus_report.aspx.cs" Inherits="SigmaERP.leave.yearly_leaveStatus_report" %>
        ...
        <div class="col-md-12 ds_nagevation_bar">
            <div style="margin-top: 5px">
                <ul>
                    ...
                    <li>/</li>
                    <li><a href="#" class="ds_negevation_inactive Lactive">Leave Status Reports</a></li>
                </ul>
            </div>
        </div>
    </div>
    	...
    	<div class="main_box_body_leave Lbody">
            <div class="main_box_content_leave">
                ...
                <h1  runat="server" visible="false" id="WarningMessage"  style="color:red; text-align:center"></h1>
                    <center>
                        <asp:RadioButtonList runat="server" ID="rblReportType" AutoPostBack="true" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblReportType_SelectedIndexChanged">
                        <asp:ListItem Selected="True" Value="Monthly">Monthly Status</asp:ListItem>
                        <asp:ListItem Value="Yearly">Yearly Status</asp:ListItem>
                    </asp:RadioButtonList>
                    <asp:CheckBox runat="server" ID="ckbIndividualDetails"  Text="Individual Details" Visible="false"/>
                    </center>
                     ...
                     <table runat="server" visible="true" id="tblGenerateType" class="division_table_leave1" style="margin:0px auto">                                                                      
                                ...
                                <tr id="trForCompanyList" runat="server" visible="false">
                                <td>Company</td>
                                <td>
                       ...
                       <tr>
                          <td runat="server" id="tdMonthYear">Month     &nbsp;</td>                      
                           <td>
